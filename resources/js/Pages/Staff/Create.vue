            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="mt-1.5 text-sm text-gray-500">
                        أضف موظفاً جديداً لفريق العمل في محلك
                    </p>
                </div>
            </div>
        </template>
                    ...
                    <div class="overflow-hidden rounded-3xl border border-gray-200/80 bg-white shadow-sm">
                        ...
                        <div class="flex items-center gap-4 border-b border-gray-100 px-6 py-6 sm:px-8">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">معلومات الدخول الأساسية للموظف</p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-5 px-6 py-7 sm:px-8">
                            ...
                            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                <div>
                                    <label for="email" class="mb-2 block text-sm font-semibold text-gray-700">البريد الإلكتروني</label>
                                    <input
                                ...
                                <div>
                                    <label for="password" class="mb-2 block text-sm font-semibold text-gray-700">كلمة المرور</label>
                                    <input
                                        id="password" type="password" v-model="form.password" required
                                        dir="ltr"
                                        class="block w-full rounded-xl border-gray-200 text-left text-sm text-gray-800 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    />
